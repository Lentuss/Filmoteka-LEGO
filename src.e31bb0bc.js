...
},{"./..\\images\\home-mobile.jpg":[["home-mobile.158c82c3.jpg","images/home-mobile.jpg"],"images/home-mobile.jpg"],"./..\\images\\home-mobile-x2.jpg":[["home-mobile-x2.fb33ecfb.jpg","images/home-mobile-x2.jpg"],"images/home-mobile-x2.jpg"],"./..\\images\\home-pc.jpg":[["home-pc.ee1d9a6a.jpg","images/home-pc.jpg"],"images/home-pc.jpg"],"./..\\images\\home-pc-x2.jpg":[["home-pc-x2.2ef607a9.jpg","images/home-pc-x2.jpg"],"images/home-pc-x2.jpg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/fireDb.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.MovieDataBase = void 0;

class MovieDataBase {
  static create(database) {
    fetch('https://filmoteka-group5-default-rtdb.europe-west1.firebasedatabase.app/movieDb.json', {
      method: 'post',
      ...
      return database;
    }).then(addToLocalStorage).then(MovieDataBase.renderList);
  }

  static renderList(aasda) {
    const moviesFromLS = getFromLocalStorage();
    const html = moviesFromLS.length ? moviesFromLS.map(toCard).join('') : `<div>Здесь пока ничего нет</div>`;
...
},{}],"js/apiVariables.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.BACKDROP_URL = exports.IMAGE_URL = exports.GENRES_URL = exports.DETAILS_URL = exports.SEARCH_URL = exports.TREND_URL = exports.BASE_URL = exports.API_KEY = void 0;
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"js/getFilmsApiService.js":[function(require,module,exports) {
"use strict";
...
var _apiVariables = require("./apiVariables");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

class GetFilmsApiService {
  constructor(url) {
    this.page = 1;
    this.period = 'day';
    this.searchRequest = "";
  ...
  async getFilms() {
    ...
    try {
      if (this.url === _apiVariables.SEARCH_URL) {
        searchLink = `${this.url}?api_key=${_apiVariables.API_KEY}&page=${this.page}&query=${this.searchRequest}`;
      } else if (this.url === _apiVariables.BASE_URL) {
        searchLink = `${_apiVariables.BASE_URL}trending/all/${this.period}?api_key=${_apiVariables.API_KEY}&page=${this.page}`;
      }

      const response = await _axios.default.get(searchLink);
...
exports.default = GetFilmsApiService;
},{"axios":"../node_modules/axios/index.js","./apiVariables":"js/apiVariables.js"}],"js/getGenres.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getGenreById = exports.getGenres = void 0;

var _apiVariables = require("./apiVariables");

const getGenres = () => {
  return fetch(`${_apiVariables.GENRES_URL}?api_key=${_apiVariables.API_KEY}&language=en-US`);
};
...
getGenreById(12);
},{"./apiVariables":"js/apiVariables.js"}],"js/getTrendFilms.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getTrendFilms = getTrendFilms;

var _apiVariables = require("./apiVariables");

var _getGenres = require("./getGenres");

var _getFilmsApiService = _interopRequireDefault(require("./getFilmsApiService"));

var _renderFilms = require("./renderFilms");
...
const getFilmsApiService = new _getFilmsApiService.default(_apiVariables.BASE_URL);
...
function onGetSucces(requestedFilms) {
  listEl.insertAdjacentHTML('beforeend', (0, _renderFilms.createListMarkup)(requestedFilms));
...
},{"./apiVariables":"js/apiVariables.js","./getGenres":"js/getGenres.js","./getFilmsApiService":"js/getFilmsApiService.js","./renderFilms":"js/renderFilms.js"}],"js/renderFilms.js":[function(require,module,exports) {
"use strict";
...
var _getTrendFilms = require("./getTrendFilms");

function createListMarkup(requestedFilms) {
  return requestedFilms.results.map(({
    id,
    poster_path,
    original_title,
    original_name,
    ...
    let posterPicture = `${_apiVariables.IMAGE_URL + poster_path}`;
...
},{"./apiVariables":"js/apiVariables.js","./getTrendFilms":"js/getTrendFilms.js"}],"js/filmSearch.js":[function(require,module,exports) {
"use strict";
...
const movieAPIService = new _getFilmsApiService.default();
...
function onGetSucces(movieFromApi) {
  const movieForRender = (0, _renderFilms.createListMarkup)(movieFromApi);
...
const observer = new IntersectionObserver(callback, options.intersectionObserver);
},{"./apiVariables":"js/apiVariables.js","./getFilmsApiService":"js/getFilmsApiService.js","./renderFilms":"js/renderFilms.js","./getTrendFilms":"js/getTrendFilms.js"}],"js/renderLibrary.js":[function(require,module,exports) {
"use strict";
...
},{}],"js/getDetails.js":[function(require,module,exports) {
"use strict";
...
const detCloseBtn = document.querySelector('.details__close-button'); /// если нет деталей
// если нет постера
//если нет бекдропа
//если нет ничего
//очистка
...
async function getDetails(movieId) {
  const details = await _axios.default.get(`${_apiVariables.DETAILS_URL + movieId}?api_key=${_apiVariables.API_KEY}&language=en-US`).then(({
    data
  }) => data);
  const {
    backdrop_path,
  ...
  backdropDetails.style.backgroundImage = `url(${_apiVariables.BACKDROP_URL + backdrop_path})`; //дописать логику отсутствия

  const infoBox = document.querySelector('.details__info');
  const markupImg = `<div class="details__poster">
                    <img class="details__image"
                        src="${_apiVariables.IMAGE_URL + poster_path}" alt="${title}poster"
                        width="375px" />
                </div>`;
  const markup = `
...
},{"./apiVariables":"js/apiVariables.js","axios":"../node_modules/axios/index.js"}],"js/setDetails.js":[function(require,module,exports) {
"use strict";

var _getDetails = _interopRequireWildcard(require("./getDetails"));
...
},{"./getDetails":"js/getDetails.js"}],"js/scrollUp.js":[function(require,module,exports) {
const upBtnEl = document.querySelector(".upBtn");
upBtnEl.addEventListener('click', topFunction); // Коли користувач скролить на 100px вниз, то з'являється кнопка
...
},{}],"js/themeSwitcher.js":[function(require,module,exports) {
...
function onSwitchClick() {
  if (checkbox.checked) {
    ...
    body.classList.remove('light-theme'); // genres.classList.add('dark-theme');
    // genres.classList.remove('light-theme');

    section.classList.add('dark-on');
    section.classList.remove('light-on'); // movieDesc.classList.add('dark-theme');
    // movieDesc.classList.remove('light-theme');
    // backdrop.classList.add('dark-theme');
    // backdrop.classList.remove('light-theme');
  } else {
    body.classList.add('light-theme');
    body.classList.remove('dark-theme'); //     genres.classList.add('light-theme');
    //     genres.classList.remove('dark-theme');

    section.classList.add('light-on');
    section.classList.remove('dark-on'); //     movieDesc.classList.add('light-theme');
...
require("./js/filmSearch");

require("./js/renderLibrary");

require("./js/getFilmsApiService");

require("./js/renderFilms");

require("./js/getDetails");

require("./js/setDetails");

require("./js/getTrendFilms");

require("./js/getGenres");

require("./js/apiVariables");

require("./js/scrollUp");

require("./js/footer");

require("./js/themeSwitcher");
},{"./sass/index.scss":"sass/index.scss","./js/fireDb":"js/fireDb.js","./js/filmSearch":"js/filmSearch.js","./js/renderLibrary":"js/renderLibrary.js","./js/getFilmsApiService":"js/getFilmsApiService.js","./js/renderFilms":"js/renderFilms.js","./js/getDetails":"js/getDetails.js","./js/setDetails":"js/setDetails.js","./js/getTrendFilms":"js/getTrendFilms.js","./js/getGenres":"js/getGenres.js","./js/apiVariables":"js/apiVariables.js","./js/scrollUp":"js/scrollUp.js","./js/footer":"js/footer.js","./js/themeSwitcher":"js/themeSwitcher.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
